          ...
          <div className="space-y-4">
            ...
            {payloadKind === 'agentTurn' && (
              <SectionShell
                ...
                description="Choose whether the result stays in ClawDash or gets sent out."
              >
                <div className="flex flex-col gap-1">
                  ...
                  >
                    ...
                    <option value="none">Keep it inside ClawDash</option>
                  </CronSelect>
                </div>
                  ...
                  <div className="space-y-2.5">
                    {availableChannels.length === 0 ? (
                      <div className="rounded-[18px] border border-orange/30 bg-orange/6 px-3 py-3 text-[0.733rem] text-orange/85">
                        No messaging channels are configured yet. Set one up in OpenClaw first, or keep the job inside ClawDash.
                      </div>
                    ) : (
                      <div className="grid gap-3 sm:grid-cols-2">
                        <div className="flex flex-col gap-1">
                    ...
                    <div className="cockpit-note" data-tone="primary">
                      ClawDash appends the delivery instruction so the agent can send the result directly when it finishes.
                    </div>
                  </div>
                )}
              </SectionShell>
